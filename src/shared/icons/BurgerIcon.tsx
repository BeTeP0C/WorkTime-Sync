...
export const BurgerIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M3.75 16.5C3.33579 16.5 3 16.8358 3 17.25C3 17.6642 3.33579 18 3.75 18H20.25C20.6642 18 21 17.6642 21 17.25C21 16.8358 20.6642 16.5 20.25 16.5H3.75Z"
        fill="currentColor"
      />
    </svg>
  )
